...
DOMContentLoaded event: Ensures the script runs after the HTML document has been completely loaded and parsed.
menuToggle: Selects the menu toggle button.
mobileMenu: Selects the mobile menu container.
hamburgers: Selects all elements with the class hamburger.
